...
public class CompanyMemberAuthorizationManager implements AuthorizationManager<RequestAuthorizationContext> {
    ...
    public void setCompanyServicePort(CompanyServicePort companyServicePort) {
        CompanyMemberAuthorizationManager.companyServicePort = companyServicePort;
    }
    ...
    public AuthorizationDecision check(Supplier<Authentication> authentication, RequestAuthorizationContext object) {
        ...
        try {
            Company company = CompanyMemberAuthorizationManager.companyServicePort.findCompanyById(CompanyId.of(companyId));
