package thi.cnd.authservice.primary.security;
...
import thi.cnd.authservice.primary.security.authorization.AuthenticationTypeAuthorizationManager;
import thi.cnd.authservice.primary.security.authorization.IdMatcherAuthorizationManager;
