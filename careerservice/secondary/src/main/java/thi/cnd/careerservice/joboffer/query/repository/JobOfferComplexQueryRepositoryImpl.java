...
import static thi.cnd.careerservice.joboffer.command.domain.model.JobOfferStatus.OPEN;
...
public class JobOfferComplexQueryRepositoryImpl implements JobOfferComplexQueryRepository {
    ...
    @Override
    public Page<JobOfferViewDAO> findAllOpen(AvailableJobOfferSearchFilter filter) {
